...
// ============================================================
// AIM Annual Report 2025 — "THE CONTEXT GAP" v3
// Updated from: context gap v3 2025-12-31.md (Ray Svitla)
...
const RAW_SLIDES: SlideData[] = [
  ...
  // Slide 2 — What this is (and isn't)
  {
    ...
    visual: 'network',
    layout: 'paired',
    leftTitle: "you'll go through 10 paired loops",
    leftContent: [
  ...
  // ═══════════════════════════════════════════════════════════════════
  // 10 PAIRED LOOPS (Slides 6-16)
  // ═══════════════════════════════════════════════════════════════════

  // Section divider
  {
    id: 7,
    title: '10 paired loops',
    subtitle: 'machines ↔ humans',
    visual: 'SECTION_DIVIDER',
    sectionTitle: 'loops',
    dark: true,
    caption: 'each loop ends with the gap — and where coordination breaks.',
    layout: 'center',
  },

  // LOOP 1: System-2 Reasoning — INTRO
  {
    id: 8,
    title: 'loop 1: system-2 reasoning',
    subtitle: '"chat" is turning into delegation.',
    visual: 'trust',
    layout: 'loop-intro',
  },
  // LOOP 1: System-2 Reasoning — FULL
  {
    id: 9,
    title: 'loop 1: system-2 reasoning',
    subtitle: '"chat" is turning into delegation.',
  ...
  // LOOP 1: System-2 Reasoning — EVIDENCE
  {
    id: 100,
  ...
  // LOOP 2: Orchestration Layers — INTRO
  {
    id: 10,
    title: 'loop 2: orchestration layers',
    subtitle: 'the center of gravity moves from chat to agentic workflows.',
    visual: 'overload',
    layout: 'loop-intro',
  },
  // LOOP 2: Orchestration Layers — FULL
  {
    id: 11,
    title: 'loop 2: orchestration layers',
    subtitle: 'the center of gravity moves from chat to agentic workflows.',
  ...
  // LOOP 2: Orchestration Layers — EVIDENCE
  {
    id: 101,
  ...
  // LOOP 3: Sovereign AI — INTRO
  {
    id: 12,
    title: 'loop 3: sovereign ai',
    subtitle: 'regulation matures. institutions define "unacceptable risk."',
    visual: 'locked',
    layout: 'loop-intro',
  },
  // LOOP 3: Sovereign AI — FULL
  {
    id: 13,
    title: 'loop 3: sovereign ai',
    subtitle: 'regulation matures. institutions define "unacceptable risk."',
  ...
  // LOOP 5: On-Device Models ↔ Privacy as Status — INTRO
  {
    id: 16,
    title: 'loop 5: on-device models ↔ privacy as status',
    subtitle: 'smaller models get good enough and spread everywhere.',
    visual: 'unlocked',
    layout: 'loop-intro',
  },
  // LOOP 5: On-Device Models ↔ Privacy as Status — FULL
  {
    id: 17,
    title: 'loop 5: on-device models ↔ privacy as status',
    subtitle: 'smaller models get good enough and spread everywhere.',
  ...
  // LOOP 6: Compute & Energy ↔ Return of Physics — INTRO
  {
    id: 18,
    title: 'loop 6: compute & energy ↔ return of physics',
    subtitle: "ai isn't just software. it's infrastructure.",
    visual: 'pulse',
    layout: 'loop-intro',
    dark: true,
  },
  // LOOP 6: Compute & Energy ↔ Return of Physics — FULL
  {
    id: 19,
    title: 'loop 6: compute & energy ↔ return of physics',
    subtitle: "ai isn't just software. it's infrastructure.",
  ...
  // LOOP 6: Compute & Energy — EVIDENCE
  {
    id: 105,
  ...
  // LOOP 7: Coding Agents ↔ Authorship Anxiety — INTRO
  {
    id: 20,
    title: 'loop 7: coding agents ↔ authorship anxiety',
    subtitle: 'coding becomes the first broadly proven agent category.',
    visual: 'centaur',
    layout: 'loop-intro',
  },
  // LOOP 7: Coding Agents ↔ Authorship Anxiety — FULL
  {
    id: 21,
    title: 'loop 7: coding agents ↔ authorship anxiety',
    subtitle: 'coding becomes the first broadly proven agent category.',
  ...
  // LOOP 8: Regional Frames — INTRO
  {
    id: 22,
    title: 'loop 8: regional frames',
    subtitle: 'ai progress is global, but governance differs by region.',
    visual: 'mirror',
    layout: 'loop-intro',
  },
  // LOOP 8: Regional Frames — FULL
  {
    id: 23,
    title: 'loop 8: regional frames',
    subtitle: 'ai progress is global, but governance differs by region.',
  ...
  // LOOP 8: Regional Frames — EVIDENCE
  {
    id: 107,
  ...
  // LOOP 9: Post-Training Default Values — INTRO
  {
    id: 24,
    title: 'loop 9: post-training default values',
    subtitle: 'post-training defines behavior: refusals, style, safety posture.',
    visual: 'filter',
    layout: 'loop-intro',
  },
  // LOOP 9: Post-Training Default Values — FULL
  {
    id: 25,
    title: 'loop 9: post-training default values',
    subtitle: 'post-training defines behavior: refusals, style, safety posture.',
  ...
  // LOOP 10: Machine Intimacy + Programmable Identity — INTRO
  {
    id: 26,
    title: 'loop 10: machine intimacy + programmable identity',
    subtitle: 'ai moves from tool to relationship surface.',
    visual: 'echo',
    layout: 'loop-intro',
  },
  // LOOP 10: Machine Intimacy + Programmable Identity — FULL
  {
    id: 27,
    title: 'loop 10: machine intimacy + programmable identity',
    subtitle: 'ai moves from tool to relationship surface.',
  ...
  // LOOP 10: Machine Intimacy — EVIDENCE
  {
    id: 109,
  ...
  // Section divider
  {
    ...
    caption: 'that ground our 10 loops in lived experience.',
    layout: 'center',
  },

  // Slide 22 — Field Signals
  {
    id: 23,
    title: 'field signals',
  ...
  // Slide 26 — AI: Capability, Infra, Adoption
  {
    id: 27,
  ...
  // Slide 27 — Data: Limits + Synthetic Loops
  {
    id: 28,
  ...
  // Slide 28 — Humans: Overload, Trust, Culture
  {
    id: 29,
  ...
  // Slide 29 — Governance / Philosophy
  {
    id: 30,
  ...
  // Slide 30 — Frame: Attention, Cognition, Acceleration, Sovereignty
  {
    id: 31,
  ...
  // Slide 32 — AI Mindset Field Notes
  {
    id: 33,
...
export const SECTIONS: Section[] = [
  ...
  { title: '10 loops', startSlide: 6 },
  { title: 'summary', startSlide: 37 },  // +10 evidence slides
  { title: 'action', startSlide: 39 },
  { title: 'community', startSlide: 41 },
  { title: 'sources', startSlide: 45 },
];
